...
Si vous avez des soucis d'encodage (affichage des accents), il est possible de convertir les fichiers textes en utilisant la commande iconv. Cela dépend de votre environnement. 
  ...
  # Connaître l'encodage d'un fichier avec la commande FILE
  # file nom_fichier permet de connaître l'encodage d'un fichier
